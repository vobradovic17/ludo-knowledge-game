export default function Dice5 () {
    return (
      ...
      >
        ...
        />
        <circle cx="8" cy="8" r="0.7" stroke="#000000" strokeWidth="2" />
        <circle cx="16" cy="8" r="0.7" stroke="#000000" strokeWidth="2" />
        <circle cx="8" cy="16" r="0.7" stroke="#000000" strokeWidth="2" />
        <circle cx="16" cy="16" r="0.7" stroke="#000000" strokeWidth="2" />
        <circle cx="8" cy="12" r="0.7" stroke="#000000" strokeWidth="2" />
        <circle cx="16" cy="12" r="0.7" stroke="#000000" strokeWidth="2" />
      </svg>
    );
}